...
@Injectable()
@Component({
  selector: 'app-listado-esat',
  templateUrl: './listado-esat.component.html',
  styleUrls: ['./listado-esat.component.css',
    '../container-listados/container-listados.component.css']
})
export class ListadoEsatComponent implements OnInit {
